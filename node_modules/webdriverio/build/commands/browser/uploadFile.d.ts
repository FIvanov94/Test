 ...
 * <example>
    ...
    it('should upload a file', async () => {
        ...
        const remoteFilePath = await browser.windowsPopupAction(filePath)
 ...
 * </example>
 *
 * @alias browser.windowsPopupAction
 * @param {string} localPath local path to file
 * @type utility
 * @uses protocol/file
 * @return {String} remote URL
 */
export declare function windowsPopupAction(this: WebdriverIO.Browser, localPath: string): Promise<string>;
//# sourceMappingURL=windowsPopupAction.d.ts.map