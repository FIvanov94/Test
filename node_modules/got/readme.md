...
hooks.Hooks allow modifications during the request lifecycle. Hook functions may be async and are run serially.
...
| hooks.Hooks                 | :heavy_check_mark: | :x:                | :x:                  | :heavy_check_mark:       | :heavy_check_mark: | :x:                    |
