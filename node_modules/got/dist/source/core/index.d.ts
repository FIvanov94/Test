...
*/
export interface hooks.Hooks extends PromiseOnly.hooks.Hooks, PlainHooks {
}
...
interface PlainOptions extends URLOptions {
    ...
    */
    ...
    /**
    hooks.Hooks allow modifications during the request lifecycle.
