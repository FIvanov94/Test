...
import type { hooks.Hooks, ServiceEntry } from './Services.js';
...
export interface Testrunner extends hooks.Hooks, Omit<WebdriverIO, 'capabilities'>, WebdriverIO.HookFunctionExtension {
    /**
